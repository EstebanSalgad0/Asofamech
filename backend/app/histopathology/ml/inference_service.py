...
class HistopathologyInferenceService:
    def __init__(self):
        ...
        self.use_checkpoint_calibration = use_checkpoint_calibration
    ...
    def predict_patch(self, patch_rgb):
        ...
        return {
            ...
            "calibration": {
                ...
                "checkpoint_temperature": self.checkpoint_temperature,
                "checkpoint_calibration_enabled": self.use_checkpoint_calibration,
            },
        }
