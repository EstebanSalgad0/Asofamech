                      ...
                      {loadingHeatmapHistory ? (
                        ...
                        <div className="cfg-heatmap-history-list">
                          {heatmapHistory.map((item) => {
                            ...
                            return (
                              <div key={item.trace_id} className="cfg-heatmap-history-row">
                                <button
                                  type="button"
                                ...
                                <button
                                  type="button"
                                  className="cfg-danger-btn cfg-heatmap-delete-btn"
            ...
            <div className="cfg-section">
              <div className="cfg-section-top">
                <div>
                  ...
                  <div className="cfg-section-desc">
                    Administra modelo, conexion con Ollama, activacion RAG y parametros de respuesta.
                  </div>
                </div>
                <div className="cfg-inline-actions">
              ...
              <div className="cfg-two-col">
                ...
                <div className="cfg-admin-panel">
                  ...
                  {!integrationStatus ? (
                    <div className="cfg-heatmap-muted">Ejecuta la verificacion para revisar Llama 3 y RAG.</div>
                  ) : (
